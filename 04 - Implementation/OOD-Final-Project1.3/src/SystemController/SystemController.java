...
//			显示窗体
		...
		JButton B13 = new JButton("2019.9.21");
		B13.setBackground(new Color((float)0.854,(float)0.90,(float)0.98));
		setButtonLocation(B13, 1.0/12+1.0/12+1.0/6, 1.0/12+1.0/10*5+1.0/10*1.5);
		conn.add(B13);
